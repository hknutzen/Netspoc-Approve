...
############################################################
=TITLE=Remove header from files error
=DEVICE=
#http://device.ipaddress/url
...
[[one_rule]]
=ERROR=
ERROR>>> Can't parse device: invalid character '#' looking for beginning of value
=END=

############################################################
=TITLE=Remove header from files 2
=DEVICE=#http:
=NETSPOC={}
=ERROR=
ERROR>>> Can't parse device: unexpected end of JSON input
=END=
